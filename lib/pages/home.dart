...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    // Note: The user's code had a separate MaterialApp built in. 
    // Since we already have a MaterialApp in main.dart, we just apply the theme colors locally
    // or rely on the main theme. For now, we'll build the Scaffold directly.
    
    // We recreate the theme colors locally so the design works inside our existing app structure
    final colorScheme = ColorScheme.fromSeed(
      seedColor: const Color(0xFF6750A4),
      brightness: Brightness.light,
    );
    
    // Wrap in Theme to strictly apply PolicyLens colors to this page
    return Theme(
      data: ThemeData(
        useMaterial3: true,
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: Column(
            children: [
              _buildTopAppBar(context, colorScheme),
              Expanded(
  ...
  Widget _buildTopAppBar(BuildContext context, ColorScheme colorScheme) {
